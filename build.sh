...
command -v s2i || { echo -e 'Please ensure s2i is installed and on your PATH
See: https://github.com/openshift/source-to-image' >&2; exit 1; }

s2i_build RobotMakerExpress2000 jmc-robots-demo/robotmaker
s2i_build RobotShop jmc-robots-demo/robotshop 'http://robotmaker'
s2i_build RobotController jmc-robots-demo/robotcontroller 'http://robotmaker'
